    ...
    <div class="row">
        <div id="wizard" class="form_wizard wizard_horizontal">
            <div class="wizard_content" style="display: block;">
                ...
                <div class="form-group" id='mentor_name'>
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <?php
                        echo $form->labelEx($model, 'mentor_id') . '<br/>';
                        $this->widget('booster.widgets.TbSelect2', array(
                            'asDropDownList' => TRUE,
                            'model' => $model,
                            'name' => 'TgistStudentForm[mentor_id]',
                            'data' => TgistStudentForm::FindMentor(),
                            'value' => $model->mentor_id,
                            'options' => array(
                                'placeholder' => '--- เลือก นักวิจัย สวทช. ---',
                                'width' => '100%',
                            ),
                        ));
                        echo '<br/>';
                ...
                <div class="form-group ">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <label><span class="required">**กรณีที่ยังไม่มีข้อมูล ให้กรอกอีเมลล์ของนักวิจัย สวทช.</span></label>
                    </div>
                </div>
                
                <div class="form-group" id='mentor_email' >
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <?php
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <label>
                            <span class="required">**ระบบจะส่ง e-mail ไปที่นักวิจัย สวทช. เพื่อกรอกข้อมูล</span>
                        </label>
                    </div>
                </div>
                <hr>
...
<script>
    ...
    function disableForm(){
        ...
        $("#" + formname + "_mentor_id").attr("disabled","disabled");
        $("#" + formname + "_mentor_id").attr("readonly","readonly");
    }
    ...
    var formname = "TgistStudentForm";
        ...
        $("#" + formname + "_email" ).focusout(function() {
           ...
           if($.isBlank(email)){
               $("#s2id_" + formname + "_mentor_id").attr("class","select2-container");
               $("#" + formname + "_mentor_id").removeAttr("disabled");
               $("#" + formname + "_mentor_id").removeAttr("readonly");
           }
         });
...
//                                  $("#confirmemail").click();
                                    ...
                                    $.post("getPersonDetail",
                                    {
                                        ...
                                        data = $.parseJSON(data);
                                        $("#s2id_" + formname + "_mentor_id").addClass("select2-container-disabled");
                                        $("#" + formname + "_mentor_id").select2("val", data.id);
                                        $("#" + formname + "_mentor_id").val(data.id).attr("readonly","readonly").attr("disabled","readonly");
        ...
        $("#" + formname + "_mentor_id").change(function () {
//            disableFormEmail();
                $("#loading").show();
//                disableFormEmail();
                $.post("isAlreadyID",
...
//                                  $("#confirmemail").click();
                                ...
                                {
                                    type: 'mentor',
                                    mentor_id: $("#" + formname + "_mentor_id").val(),
                                }, function (data, status) {
                                    data = $.parseJSON(data);
