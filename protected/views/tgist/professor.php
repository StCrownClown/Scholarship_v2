    ...
    <div class="row">
        <div id="wizard" class="form_wizard wizard_horizontal">
            <div class="wizard_content" style="display: block;">
                ...
                <div class="form-group" id='professor_name'>
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <?php
                        echo $form->labelEx($model, 'professor_id') . '<br/>';
                        $this->widget('booster.widgets.TbSelect2', array(
                            'asDropDownList' => TRUE,
                            'model' => $model,
                            'name' => 'TgistStudentForm[professor_id]',
                            'data' => TgistStudentForm::FindProfessor(),
                            'value' => $model->professor_id,
                            'options' => array(
                                'placeholder' => '--- เลือก อาจารย์ที่ปรึกษา ---',
                                'width' => '100%',
                            ),
                        ));
                        echo '<br/>';
                ...
                <div class="form-group ">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <label><span class="required">**กรณีที่ยังไม่มีข้อมูล ให้กรอกอีเมลล์ของอาจารย์ที่ปรึกษา</span></label>
                    </div>
                </div>
                
                <div class="form-group" id='professor_email' >
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <?php
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <label>
                            <span class="required">**ระบบจะส่ง e-mail ไปที่อาจารย์ที่ปรึกษา เพื่อกรอกข้อมูล</span>
                        </label>
                    </div>
                </div>
                <hr>
...
<script>
    ...
    function disableForm(){
        var formname = "TgistStudentForm";
        $("#s2id_" + formname + "_id").addClass("select2-container-disabled");
        $("#" + formname + "_professor_id").attr("disabled","disabled");
        $("#" + formname + "_professor_id").attr("readonly","readonly");
    }
    ...
    var formname = "TgistStudentForm";
        ...
        $("#" + formname + "_email" ).focusout(function() {
           ...
           if($.isBlank(email)){
               $("#s2id_" + formname + "_professor_id").attr("class","select2-container");
               $("#" + formname + "_professor_id").removeAttr("disabled");
               $("#" + formname + "_professor_id").removeAttr("readonly");
           }
         });
...
//                                  $("#confirmemail").click();
                                    ...
                                    $.post("getPersonDetail",
                                    {
                                        ...
                                        data = $.parseJSON(data);
                                        $("#s2id_" + formname + "_professor_id").addClass("select2-container-disabled");
                                        $("#" + formname + "_professor_id").select2("val", data.id);
                                        $("#" + formname + "_professor_id").val(data.id).attr("readonly","readonly").attr("disabled","readonly");
        ...
        $("#" + formname + "_professor_id").change(function () {
//            disableFormEmail();
                $("#loading").show();
//                disableFormEmail();
                $.post("isAlreadyID",
...
//                                  $("#confirmemail").click();
                                ...
                                {
                                    type: 'professor',
                                    professor_id: $("#" + formname + "_professor_id").val(),
                                }, function (data, status) {
                                    data = $.parseJSON(data);
