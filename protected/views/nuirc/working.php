...
<script>
    $(document).ready(function () {
        /*$("#NuircWorkingForm_work_phone").keypress(function(event){
            if(event.which != 8 && isNaN(String.fromCharCode(event.which))){
                event.preventDefault(); //stop character from entering input
            }
        });*/
        
        $('input[name="NuircWorkingForm[is_work]"]').change(function () {
            is_work = $('input[name="NuircWorkingForm[is_work]"]:checked').val();
            if (is_work == '0') {
                $('#work_box').hide();
                $('#NuircWorkingForm_work_company').val('');
                $('#NuircWorkingForm_work_location').val('');
                $('#NuircWorkingForm_work_phone').val('');
                $('#NuircWorkingForm_work_fax').val('');
            } else if (is_work == '1') {
                $('#work_box').show();
                $('#NuircWorkingForm_work_company').val('');
                $('#NuircWorkingForm_work_location').val('');
        ...
        $('input[name="NuircWorkingForm[is_workwithproject]"]').change(function () {
            is_workwithproject = $('input[name="NuircWorkingForm[is_workwithproject]"]:checked').val();
            if (is_workwithproject == '0') {
                $('#workwithproject_box').hide();
                $('#NuircWorkingForm_workwithproject_text1').val('');
                $('#NuircWorkingForm_workwithproject_text2').val('');
                $('#NuircWorkingForm_workwithproject_text3').val('');
