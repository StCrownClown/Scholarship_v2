...
<script>
    $(document).ready(function () {
        $("input[type=checkbox]").change(function () {
            ...
            var label = id.replace("NuircExperienceForm_", "");
            
            if($(this).attr('id').replace("NuircExperienceForm_", "") == "portfolio_other"){
                if ($(this).is(':checked')) {
                    $("#NuircExperienceForm_portfolio_other_text").show();
                } else {
                    $("#NuircExperienceForm_portfolio_other_text").attr('style','display:inline;').hide().val('');
                }
            }
            if ($(this).is(':checked')) {
                $("#" + id).show();
        ...
        $('input[name="NuircExperienceForm[is_experience]"]').change(function () {
            is_experience = $('input[name="NuircExperienceForm[is_experience]"]:checked').val();
            if (is_experience == '0') {
                $('#experience_box').hide();
                $('#NuircExperienceForm_portfolio_journal_international').val('');
                $('#NuircExperienceForm_portfolio_journal_incountry').val('');
                $('#NuircExperienceForm_portfolio_patent').val('');
                $('#NuircExperienceForm_portfolio_prototype').val('');
                $('#NuircExperienceForm_portfolio_conference_international').val('');
                $('#NuircExperienceForm_portfolio_conference_incountry').val('');
                $('#NuircExperienceForm_portfolio_award').val('');
                $('#NuircExperienceForm_portfolio_other').val('');
                $('#NuircExperienceForm_portfolio_journal_international_amount').val('');
                $('#NuircExperienceForm_portfolio_journal_incountry_amount').val('');
                $('#NuircExperienceForm_portfolio_patent_amount').val('');
                $('#NuircExperienceForm_portfolio_prototype_amount').val('');
                $('#NuircExperienceForm_portfolio_conference_international_amount').val('');
                $('#NuircExperienceForm_portfolio_conference_incountry_amount').val('');
                $('#NuircExperienceForm_portfolio_award_amount').val('');
                $('#NuircExperienceForm_portfolio_other_text').val('');
                $('#NuircExperienceForm_portfolio_journal_international_desc').val('');
                $('#NuircExperienceForm_portfolio_journal_incountry_desc').val('');
                $('#NuircExperienceForm_portfolio_patent_desc').val('');
                $('#NuircExperienceForm_portfolio_prototype_desc').val('');
                $('#NuircExperienceForm_portfolio_conference_international_desc').val('');
                $('#NuircExperienceForm_portfolio_conference_incountry_desc').val('');
                $('#NuircExperienceForm_portfolio_award_desc').val('');
                $('#NuircExperienceForm_portfolio_other_desc').val('');
                $('#NuircExperienceForm_portfolio_other_amount').val('');
            } else if (is_experience == '1') {
                $('#experience_box').show();
                $('#NuircExperienceForm_is_experience').val() == $('input[name="NuircExperienceForm[is_experience]"]:checked').val();
                $('#NuircExperienceForm_portfolio_journal_international').val('');
                $('#NuircExperienceForm_portfolio_journal_incountry').val('');
                $('#NuircExperienceForm_portfolio_patent').val('');
                $('#NuircExperienceForm_portfolio_prototype').val('');
