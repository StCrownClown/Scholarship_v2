            ...
            <div class="wizard_content" style="display: block;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            ...
                            if (!empty($model->cv_path)) {
                                ...
                                $addUrl = Yii::app()->createUrl('nuirc/download', array(
                                    'typedw' => 'cv_path',
                                ));
                ...
                <?php if ($person_type == 'industrial') { ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <?php
                            echo $form->labelEx($model, 'industrial_attachment_other2_path');
                            if(empty(Yii::app()->session['tmpReadOnly']))
                                echo CHtml::activeFileField($model, 'industrial_attachment_other2', array());
                            ?>
                        </div>
                        <?php if(empty(Yii::app()->session['tmpReadOnly'])) { ?>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <?php
                                echo "<br/>";
                                echo $form->error($model, 'industrial_attachment_other2', array(
                                    'class' => '',
                                    'style' => 'color:#b94a48;',
                                ));
                                ?>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <?php
                            if (!empty($model->industrial_attachment_other2_path)) {
                                $link = '<i class="fa fa-download"></i>  Download Additional';
                                $addUrl = Yii::app()->createUrl('nuirc/download', array(
                                    'typedw' => 'industrial_attachment_other2_path',
                                    'scholar' => $scholar_type
                                ));
                                echo CHtml::link($link, $addUrl, array(
                                    'class' => 'btn btn-info',
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <?php
                            echo $form->labelEx($model, 'industrial_attachment_other3_path');
                            if(empty(Yii::app()->session['tmpReadOnly']))
                                echo CHtml::activeFileField($model, 'industrial_attachment_other3', array());
                            ?>
                        </div>
                        <?php if(empty(Yii::app()->session['tmpReadOnly'])) { ?>
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <?php
                                echo "<br/>";
                                echo $form->error($model, 'industrial_attachment_other3', array(
                                    'class' => '',
                                    'style' => 'color:#b94a48;',
                                ));
                                ?>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <?php
                            if (!empty($model->industrial_attachment_other3_path)) {
                                $link = '<i class="fa fa-download"></i>  Download Additional';
                                $addUrl = Yii::app()->createUrl('nuirc/download', array(
                                    'typedw' => 'industrial_attachment_other3_path',
                                    'scholar' => $scholar_type
                                ));
                                echo CHtml::link($link, $addUrl, array(
                                    'class' => 'btn btn-info',
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            ...
                            if (!empty($model->industrial_certificate_path)) {
                                $link = '<i class="fa fa-download"></i>  Download Industrial Approve';
                                $addUrl = Yii::app()->createUrl('nuirc/download', array(
