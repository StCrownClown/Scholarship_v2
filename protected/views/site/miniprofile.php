    ...
    <div class="row">
        <div id="wizard" class="form_wizard wizard_horizontal">
            <div class="wizard_content" style="display: block;">
                ...
                <?php if ($person_type == 'student') { ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <label for="ProfileForm_is_taist">ปัจจุบันนักศึกษารับทุนของ สวทช. โครงการ TAIST Tokyo Tech อยู่หรือไม่</label>
                        </div>
                        <div class="col-md-12 col-sm-6 col-xs-12">
                            <div class="col-md-12 col-sm-12 col-xs-12 col-md-offset-1">
                                <?php echo $form->checkBox($model, 'is_taist'); ?>
                                <?php echo $form->labelEx($model, 'is_taist'); ?>
                            </div>
                        </div>
                    </div>
                <?php } ?>
                ...
                if ($person_type == 'mentor' || $person_type == 'professor') {
                    ?>
                    <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <?php
                ...
                <?php if ($person_type == 'student') { ?>
                    <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <h3>ผู้ที่สามารถติดต่อได้กรณีฉุกเฉิน / Who can be contacted in case of emergency.</h3>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <?php
                            echo $form->textFieldGroup($model, 'parent_fname', array(
                                'wrapperHtmlOptions' => array(
                                    'class' => 'form-control',
                                ),
                                'widgetOptions' => array(
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <?php
                            echo $form->textFieldGroup($model, 'parent_lname', array(
                                'wrapperHtmlOptions' => array(
                                    'class' => 'form-control',
                                ),
                                'widgetOptions' => array(
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <?php
                            echo $form->textFieldGroup($model, 'parent_mobile', array(
                                'wrapperHtmlOptions' => array(
                                    'class' => 'form-control',
                                ),
                                'widgetOptions' => array(
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <?php
                            echo $form->textFieldGroup($model, 'parent_relationship', array(
                                'wrapperHtmlOptions' => array(
                                    'class' => 'form-control',
                                ),
                                'widgetOptions' => array(
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <?php
                            echo $form->textFieldGroup($model, 'parent2_fname', array(
                                'wrapperHtmlOptions' => array(
                                    'class' => 'form-control',
                                ),
                                'widgetOptions' => array(
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <?php
                            echo $form->textFieldGroup($model, 'parent2_lname', array(
                                'wrapperHtmlOptions' => array(
                                    'class' => 'form-control',
                                ),
                                'widgetOptions' => array(
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <?php
                            echo $form->textFieldGroup($model, 'parent2_mobile', array(
                                'wrapperHtmlOptions' => array(
                                    'class' => 'form-control',
                                ),
                                'widgetOptions' => array(
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <?php
                            echo $form->textFieldGroup($model, 'parent2_relationship', array(
                                'wrapperHtmlOptions' => array(
                                    'class' => 'form-control',
                                ),
                                'widgetOptions' => array(
