...
$formAciton = 'stem/recommendation';
        ...
        <div id="wizard" class="form_wizard wizard_horizontal">
            <div class="wizard_content" style="display: block;">
                ...
                <div class="form-group" id="industrial_incash_salary" style="<?php echo (empty($model->industrial_incash_salary) ? 'display:none;' : ''); ?>">
                    <div class="col-md-3 col-sm-12 col-xs-12 col-md-offset-1">
                        <?php
                        echo '<label id="StemRecommendationForm_industrial_incash_salary_label"  style="'.(empty($model->industrial_incash_salary) ? 'display:none;' : '').' ">จำนวน (บาท) ไม่ต้องใส่ , เช่น 1000000 เป็นต้น</label>';
                ...
                <div class="form-group" id="industrial_incash_rents" style="<?php echo (empty($model->industrial_incash_rents) ? 'display:none;' : ''); ?>">
                    <div class="col-md-3 col-sm-12 col-xs-12 col-md-offset-1">
                        <?php
                        echo '<label id="StemRecommendationForm_industrial_incash_rents_label"  style="'.(empty($model->industrial_incash_rents) ? 'display:none;' : '').' ">จำนวน (บาท) ไม่ต้องใส่ , เช่น 1000000 เป็นต้น</label>';
                ...
                <div class="form-group" id="industrial_incash_traveling" style="<?php echo (empty($model->industrial_incash_traveling) ? 'display:none;' : ''); ?>">
                    <div class="col-md-3 col-sm-12 col-xs-12 col-md-offset-1">
                        <?php
                        echo '<label id="StemRecommendationForm_industrial_incash_traveling_label"  style="'.(empty($model->industrial_incash_traveling) ? 'display:none;' : '').' ">จำนวน (บาท) ไม่ต้องใส่ , เช่น 1000000 เป็นต้น</label>';
                ...
                <div class="form-group" id="industrial_incash_other" style="<?php echo (empty($model->industrial_incash_other) ? 'display:none;' : ''); ?>">
                    <div class="col-md-3 col-sm-12 col-xs-12 col-md-offset-1">
                         <?php
                        echo '<label id="StemRecommendationForm_industrial_incash_other_label" style="'.(empty($model->industrial_incash_other) ? 'display:none;' : '').' ">จำนวน (บาท) ไม่ต้องใส่ , เช่น 1000000 เป็นต้น</label>';
                ...
                <div class="form-group" id="industrial_incash_other2" style="<?php echo (empty($model->industrial_incash_other2) ? 'display:none;' : ''); ?>">
                    <div class="col-md-3 col-sm-12 col-xs-12 col-md-offset-1">
                         <?php
                        echo '<label id="StemRecommendationForm_industrial_incash_other2_label" style="'.(empty($model->industrial_incash_other2) ? 'display:none;' : '').' ">จำนวน (บาท) ไม่ต้องใส่ , เช่น 1000000 เป็นต้น</label>';
                ...
                <div class="form-group" id="industrial_inkind_equipment" style="<?php echo (empty($model->industrial_inkind_equipment) ? 'display:none;' : ''); ?>">
                    <div class="col-md-3 col-sm-12 col-xs-12 col-md-offset-1">
                        <?php
                        echo '<label id="StemRecommendationForm_industrial_inkind_equipment_label"  style="'.(empty($model->industrial_inkind_equipment) ? 'display:none;' : '').' ">จำนวน (บาท) ไม่ต้องใส่ , เช่น 1000000 เป็นต้น</label>';
                ...
                <div class="form-group" id="industrial_inkind_other" style="<?php echo (empty($model->industrial_inkind_other) ? 'display:none;' : ''); ?>">
                    <div class="col-md-3 col-sm-12 col-xs-12 col-md-offset-1">
                         <?php
                        echo '<label id="StemRecommendationForm_industrial_inkind_other_label" style="'.(empty($model->industrial_inkind_other) ? 'display:none;' : '').' ">จำนวน (บาท) ไม่ต้องใส่ , เช่น 1000000 เป็นต้น</label>';
                ...
                <div class="form-group" id="industrial_inkind_other2" style="<?php echo (empty($model->industrial_inkind_other2) ? 'display:none;' : ''); ?>">
                    <div class="col-md-3 col-sm-12 col-xs-12 col-md-offset-1">
                         <?php
                        echo '<label id="StemRecommendationForm_industrial_inkind_other2_label" style="'.(empty($model->industrial_inkind_other2) ? 'display:none;' : '').' ">จำนวน (บาท) ไม่ต้องใส่ , เช่น 1000000 เป็นต้น</label>';
...
<script>
    $(document).ready(function () {
        ...
        $("#StemRecommendationForm_industrial_incash_salary").change(function () {
            if ($(this).is(':checked')) {
                $("#StemRecommendationForm_industrial_incash_salary_cost").show().val('0.00');
                $("[id^='industrial_incash_salary']").show();
            } else {
                $("#StemRecommendationForm_industrial_incash_salary_cost").hide().val('0.00');
                $("[id^='industrial_incash_salary']").hide();
            }
            calIncash();
        });
        
        $("#StemRecommendationForm_industrial_incash_rents").change(function () {
            if ($(this).is(':checked')) {
                $("#StemRecommendationForm_industrial_incash_rents_cost").show().val('0.00');
                $("[id^='industrial_incash_rents']").show();
            } else {
                $("#StemRecommendationForm_industrial_incash_rents_cost").hide().val('0.00');
        ...
        $("#StemRecommendationForm_industrial_incash_traveling").change(function () {
            if ($(this).is(':checked')) {
                $("#StemRecommendationForm_industrial_incash_traveling_cost").show().val('0.00');
                $("[id^='industrial_incash_traveling']").show();
            } else {
                $("#StemRecommendationForm_industrial_incash_traveling_cost").hide().val('0.00');
                $("[id^='industrial_incash_traveling']").hide();
            }
            calIncash();
        });
        
        $("#StemRecommendationForm_industrial_incash_other").change(function () {
            if ($(this).is(':checked')) {
                $("#StemRecommendationForm_industrial_incash_other_cost").show().val('0.00');
                $("#StemRecommendationForm_industrial_incash_other_text").show().val('');
                $("[id^='industrial_incash_other']").show();
            } else {
                $("#StemRecommendationForm_industrial_incash_other_cost").hide().val('0.00');
                $("#StemRecommendationForm_industrial_incash_other_text").hide().val('');
                $("[id^='industrial_incash_other']").hide();
            }
            calIncash();
        });
        
        $("#StemRecommendationForm_industrial_incash_other2").change(function () {
            if ($(this).is(':checked')) {
                $("#StemRecommendationForm_industrial_incash_other2_cost").show().val('0.00');
                $("#StemRecommendationForm_industrial_incash_other2_text").show().val('');
                $("[id^='industrial_incash_other2']").show();
            } else {
                $("#StemRecommendationForm_industrial_incash_other2_cost").hide().val('0.00');
                $("#StemRecommendationForm_industrial_incash_other2_text").hide().val('');
                $("[id^='industrial_incash_other2']").hide();
            }
            calIncash();
        });
        
        $("#StemRecommendationForm_industrial_inkind_equipment").change(function () {
            if ($(this).is(':checked')) {
                $("#StemRecommendationForm_industrial_inkind_equipment_cost").show().val('0.00');
                $("[id^='industrial_inkind_equipment']").show();
            } else {
                $("#StemRecommendationForm_industrial_inkind_equipment_cost").hide().val('0.00');
                $("[id^='industrial_inkind_equipment']").hide();
            }
            calInkind();
        });
        
        $("#StemRecommendationForm_industrial_inkind_other").change(function () {
            if ($(this).is(':checked')) {
                $("#StemRecommendationForm_industrial_inkind_other_cost").show().val('0.00');
                $("#StemRecommendationForm_industrial_inkind_other_text").show().val('');
                $("[id^='industrial_inkind_other']").show();
            } else {
                $("#StemRecommendationForm_industrial_inkind_other_cost").hide().val('0.00');
                $("#StemRecommendationForm_industrial_inkind_other_text").hide().val('');
                $("[id^='industrial_inkind_other']").hide();
            }
            calInkind();
        });
        
        $("#StemRecommendationForm_industrial_inkind_other2").change(function () {
            if ($(this).is(':checked')) {
                $("#StemRecommendationForm_industrial_inkind_other2_cost").show().val('0.00');
                $("#StemRecommendationForm_industrial_inkind_other2_text").show().val('');
                $("[id^='industrial_inkind_other2']").show();
            } else {
                $("#StemRecommendationForm_industrial_inkind_other2_cost").hide().val('0.00');
                $("#StemRecommendationForm_industrial_inkind_other2_text").hide().val('');
                $("[id^='industrial_inkind_other2']").hide();
            }
            calInkind();
        });
        
        $("#StemRecommendationForm_industrial_incash_salary_cost, #StemRecommendationForm_industrial_incash_rents_cost, #StemRecommendationForm_industrial_incash_traveling_cost, #StemRecommendationForm_industrial_incash_other_cost, #StemRecommendationForm_industrial_incash_other2_cost").change(function () {
        ...
        $("#StemRecommendationForm_industrial_inkind_equipment_cost,#StemRecommendationForm_industrial_inkind_other_cost,#StemRecommendationForm_industrial_inkind_other2_cost").change(function () {
            if ($.isNumeric($(this).val())) {
                calInkind();
            } else {
                $(this).val('0.00');
...
?>
    ...
    function calInkind() {
        total = 0.00;
        if ($('#StemRecommendationForm_industrial_inkind_equipment:checked').length == 1) {
            if ($.isNumeric($("#StemRecommendationForm_industrial_inkind_equipment_cost").val())) {
                total = parseFloat(total) + parseFloat($("#StemRecommendationForm_industrial_inkind_equipment_cost").val());
            }
        }
        if ($('#StemRecommendationForm_industrial_inkind_other:checked').length == 1) {
            if ($.isNumeric($("#StemRecommendationForm_industrial_inkind_other_cost").val())) {
                total = parseFloat(total) + parseFloat($("#StemRecommendationForm_industrial_inkind_other_cost").val());
            }
        }
        if ($('#StemRecommendationForm_industrial_inkind_other2:checked').length == 1) {
            if ($.isNumeric($("#StemRecommendationForm_industrial_inkind_other2_cost").val())) {
                total = parseFloat(total) + parseFloat($("#StemRecommendationForm_industrial_inkind_other2_cost").val());
            }
        }
    ...
    function calIncash() {
        total = 0.00;
        if ($('#StemRecommendationForm_industrial_incash_salary:checked').length == 1) {
            if ($.isNumeric($("#StemRecommendationForm_industrial_incash_salary_cost").val())) {
                total = parseFloat(total) + parseFloat($("#StemRecommendationForm_industrial_incash_salary_cost").val());
            }
        }
        if ($('#StemRecommendationForm_industrial_incash_rents:checked').length == 1) {
            if ($.isNumeric($("#StemRecommendationForm_industrial_incash_rents_cost").val())) {
                total = parseFloat(total) + parseFloat($("#StemRecommendationForm_industrial_incash_rents_cost").val());
            }
        }
        if ($('#StemRecommendationForm_industrial_incash_traveling:checked').length == 1) {
            if ($.isNumeric($("#StemRecommendationForm_industrial_incash_traveling_cost").val())) {
                total = parseFloat(total) + parseFloat($("#StemRecommendationForm_industrial_incash_traveling_cost").val());
            }
        }
        if ($('#StemRecommendationForm_industrial_incash_other:checked').length == 1) {
            if ($.isNumeric($("#StemRecommendationForm_industrial_incash_other_cost").val())) {
                total = parseFloat(total) + parseFloat($("#StemRecommendationForm_industrial_incash_other_cost").val());
            }
        }
        if ($('#StemRecommendationForm_industrial_incash_other2:checked').length == 1) {
            if ($.isNumeric($("#StemRecommendationForm_industrial_incash_other2_cost").val())) {
                total = parseFloat(total) + parseFloat($("#StemRecommendationForm_industrial_incash_other2_cost").val());
            }
        }
...
//                },
//                error: function () {
//                    $('#StemStudentProjectForm_func_period').val('-');
//                }
//            });
//        }
//    }
