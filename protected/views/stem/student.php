...
$this->renderPartial('../site/_x_title', array(
    'title' => 'ข้อมูลนักเรียน/นักศึกษา / Student'
));
?>
        ...
        <div id="wizard" class="form_wizard wizard_horizontal">
            <div class="wizard_content" style="display: block;">
                ...
                <div class="form-group" id='prefix_id'>
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <?php
                        $error = $form->error($model, 'prefix_id');
                        echo $form->labelEx($model, 'prefix_id') . '<br/>';
                        $this->widget('booster.widgets.TbSelect2', array(
                            'asDropDownList' => TRUE,
                            'model' => $model,
                            'name' => 'StemStudentForm[prefix_id]',
...
<script>
    ...
    $(document).ready(function () {
        if($("#s2id_StemStudentForm_prefix_id").hasClass( "select2-container-disabled" )){
            $("#s2id_StemStudentForm_prefix_id").attr('class', 'select2-container');
        }
        $('input').each(function(){
        ...
        $('#student-form').on('keyup keypress', function(e) {
