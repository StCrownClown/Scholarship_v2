...
<script>
    $(document).ready(function () {
        $("input[type=checkbox]").change(function () {
            ...
            var label = id.replace("StemExperienceForm_", "");
            
            if($(this).attr('id').replace("StemExperienceForm_", "") == "portfolio_other"){
                if ($(this).is(':checked')) {
                    $("#StemExperienceForm_portfolio_other_text").show();
                } else {
                    $("#StemExperienceForm_portfolio_other_text").attr('style','display:inline;').hide().val('');
                }
            }
            if ($(this).is(':checked')) {
                $("#" + id).show();
