    ...
    $(document).ready(function () {
        ...
        $("#" + formname + "_email").change(function () {
            ...
            if (ValidateEmail($(this).val())) {
                    $("#loading").show();
                    disableForm();
                    $.post("<?php echo Yii::app()->createUrl("stem/isAlreadyEmail") ?>",
                        {
                            type: '<?php echo $utype; ?>',
                            email: $(this).val(),
                        },
                        function (data, status) {
                            if (data == '1') {
                                ...
                                if (r == true) {
                                    // ไป get ข้อมูลมาใส่
                                    $.post("<?php echo Yii::app()->createUrl("stem/getPersonDetail") ?>",
                                    {
                                        type: '<?php echo $utype; ?>',
