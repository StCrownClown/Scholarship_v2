                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <p>หากท่านต้องการเพิ่มให้คลิ๊กที่ปุ่มนี้ / To add, click on this button.
                            ...
                            $addText = '<i class="fa fa-plus"></i> '
                                    . '<b>Add</b>';
                            $addUrl = Yii::app()->createUrl('stem/addhistory');
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('input[name="StemHistoryForm[is_history]"]').change(function () {
            is_history = $('input[name="StemHistoryForm[is_history]"]:checked').val();
            if (is_history == '0') {
                $('#history_box').hide();
