...
<script>
    $(document).ready(function () {
        $('#StemPrimaryProjectForm_begin').datepicker({
            'autoclose': true,
            'orientation': "top",
            'format': 'dd/mm/yyyy',
        ...
        $('#StemPrimaryProjectForm_end').datepicker({
            'autoclose': true,
            'orientation': "top",
            'format': 'dd/mm/yyyy',
            'viewformat': 'dd/mm/yyyy',
        ...
        $("input[name='StemPrimaryProjectForm[funding]']").change(function () {
            $('div.error').hide();
            if($(this).val() == 'source'){
                $("label[for^='StemPrimaryProjectForm_funding_name']").show();
                $('#StemPrimaryProjectForm_funding_name').show();
                $("label[for^='StemPrimaryProjectForm_funding_code']").hide();
                $('#StemPrimaryProjectForm_funding_code, #StemPrimaryProjectForm_funding_code_name').hide().val('');
                $("label[for^='StemPrimaryProjectForm_funding_etc']").hide();
                $('#StemPrimaryProjectForm_funding_etc').hide().val('');
            }else if($(this).val() == 'nstda'){
                $("label[for^='StemPrimaryProjectForm_funding_name']").hide();
                $('#StemPrimaryProjectForm_funding_name').hide().val('');
                $("label[for^='StemPrimaryProjectForm_funding_code']").show();
                ...
                $("label[for^='StemPrimaryProjectForm_funding_code']").hide();
                $('#StemPrimaryProjectForm_funding_code, #StemPrimaryProjectForm_funding_code_name').hide().val('');
                $("label[for^='StemPrimaryProjectForm_funding_etc']").show();
    ...
    function setFuncPeriod() {
        var begin = $('#StemPrimaryProjectForm_begin').val();
        var end = $('#StemPrimaryProjectForm_end').val();
        $.ajax({
            url: '<?php echo Yii::app()->createUrl('stem/get_func_period') ?>',
            data: {begin: begin, end: end, mode: 'primary'},
            type: "GET",
            success: function (data) {
                $('#StemPrimaryProjectForm_func_period').val(data);
            },
            error: function (data) {
                $('#StemPrimaryProjectForm_func_period').val(data);
            }
