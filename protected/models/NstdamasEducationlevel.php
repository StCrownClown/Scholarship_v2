...
/**
 * This is the model class for table "nstdamas_educationlevel".
 *
 * The followings are the available columns in table 'nstdamas_educationlevel':

 *
 * The followings are the available model relations:
 * @property Education[] $educations
 */
class NstdamasEducationlevel extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return NstdamasEducationlevel the static model class
	 */
	    		public $id;
			public $edl_name;
			public $edl_name_en;
	...
	{
		return 'nstdamas_educationlevel';
	}
	...
	public function rules()
	{
		...
		return array(
			array('edl_name, edl_name_en', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, edl_name, edl_name_en', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'educations' => array(self::HAS_MANY, 'Education', 'graduationlevel_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('edl_name',$this->edl_name,true);
		$criteria->compare('edl_name_en',$this->edl_name_en,true);
	...
	{
		$nstdamas_educationlevel=nstdamas_educationlevel::model()->find(array(
			'select'=>'max(id) as id',
		));
		return (isset($nstdamas_educationlevel->id))?$nstdamas_educationlevel->id+1:1;
	}

    public function saveAs()
    {
        $doc = nstdamas_educationlevel::model()->find(array(
            'select' => 'id',
            'condition' => 'id=:id',
