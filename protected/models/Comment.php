...
class Comment extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('scholar_id, person_id, steppage', 'numerical', 'integerOnly' => true),
            array('status', 'length', 'max' => 50),
            array('comment, first_created, last_updated, steppage', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, steppage, scholar_id, person_id, status, comment, first_created, last_updated', 'safe', 'on' => 'search'),
        );
    }
