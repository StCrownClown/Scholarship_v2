...
/**
 * This is the model class for table "nstdamas_nationality".
 *
 * The followings are the available columns in table 'nstdamas_nationality':

 *
 * The followings are the available model relations:
 * @property Person[] $people
 */
class NstdamasNationality extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return NstdamasNationality the static model class
	 */
	    		public $id;
			public $ntn_name;
			public $ntn_name_en;
	...
	public function rules()
	{
		...
		return array(
			...
			array('ntn_name, ntn_name_en', 'length', 'max'=>255),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, ntn_name, ntn_name_en', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'people' => array(self::HAS_MANY, 'Person', 'nationality_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('ntn_name',$this->ntn_name,true);
		$criteria->compare('ntn_name_en',$this->ntn_name_en,true);
	...
	{
		$nstdamas_nationality=nstdamas_nationality::model()->find(array(
			'select'=>'max(id) as id',
		));
		return (isset($nstdamas_nationality->id))?$nstdamas_nationality->id+1:1;
	}

    public function saveAs()
    {
        $doc = nstdamas_nationality::model()->find(array(
            'select' => 'id',
            'condition' => 'id=:id',
