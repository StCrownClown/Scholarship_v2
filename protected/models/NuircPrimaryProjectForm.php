 ...
 */
class NuircPrimaryProjectForm extends CActiveRecord {
    ...
    public function limitStart($attribute,$params){
        ...
        $begin_to = date('Y-m-d', strtotime(Yii::app()->params['nuirc_project_sub_begin_min'] . ' +6 month'));
    ...
    public function attributeLabels() {
        return array(
            ...
            'budget' => 'งบประมาณโครงการหลัก (บาท) <span class="required">*</span>',
            'func_period' => 'ระยะเวลาโครงการหลัก / Period',
            'cluster' => 'อยู่ในคลัสเตอร์ / Cluster'
        );
    }
