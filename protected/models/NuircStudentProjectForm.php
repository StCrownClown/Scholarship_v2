...
/**
 * This is the model class for table "scholar_nuirc".
 *
 * The followings are the available columns in table 'scholar_nuirc':
 ...
 */
class NuircStudentProjectForm extends CActiveRecord {

    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return NuircStudentProjectForm the static model class
     */
...
//        $begin_from = Yii::app()->params['nuirc_project_sub_begin_min'];
//        $begin_max = date('Y-m-d', strtotime(Yii::app()->params['nuirc_project_sub_begin_min'] . ' +6 month'));
...
//        $end_last = Yii::app()->params['nuirc_project_end_max'];
...
//    }
    ...
    public function relations() {
        ...
        return array(
            'scholars' => array(self::HAS_MANY, 'Scholar', 'scholar_nuirc_id'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'cooperation_industrial' => 'ลักษณะความร่วมมือในการทำวิทยานิพนธ์นิสิต/นักศึกษา และอุตสาหกรรม <span class="required">*</span>',
...
//         $scholar_nuirc = scholar_nuirc::model()->find(array(
//             'select' => 'max(id) as id',
//         ));
//         return (isset($scholar_nuirc->id)) ? $scholar_nuirc->id + 1 : 1;
//     }
