 ...
 */
class NuircWorkingForm extends CActiveRecord {
    ...
    public $is_takescholar;
    public $scholar_reason;
    ...
    public function rules() {
        return array(
            ...
            array('work_company, work_location, work_position, is_takescholar', 'reqIsOther', 'is_work'),
            ...
            array('is_takescholar, scholar_reason','safe'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'is_takescholar' => 'ในกรณีที่ท่านได้รับทุน ท่านจะ <span class="required">*</span>',
            'scholar_reason' => 'ในกรณีที่ท่านได้รับทุน ท่านจะ',
        );
    }
